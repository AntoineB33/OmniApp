...
REM =====================================================================
REM  account1-deploy-android.bat - build a DEBUG APK, install it on the
REM  connected phone over adb, wipe its local data, and launch it
REM  auto-signed-in as ACCOUNT 1.
REM
...
REM  Location: <project-root>\scripts\account1-deploy-android.bat
REM =====================================================================
...
set "OMNIAPP_DEPLOY_USER=%ACC1_USER%"
set "OMNIAPP_DEPLOY_PASS=%ACC1_PASS%"
call "%SCRIPT_DIR%internal\deploy-android-debug.bat" "account 1"
set "_RC=%ERRORLEVEL%"
