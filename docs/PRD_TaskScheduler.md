...
* **priority weight window:** 
  ...
  * The window is dismissed by clicking outside it; it also closes if its sub-list disappears or a cell enters Edit Mode.
